...
%-------------------------------------------------------------------------------
\newcommand{\name}{ {{ personal.name }} }
\newcommand{\lastname}{ {{ personal.last_name }} }
{% if 'email' in personal %} \newcommand{\email}{ {{ personal.email }} } {% endif %}
{% if 'website' in personal %} \newcommand{\website}{ {{ personal.website }} } {% endif %}
{% if 'phone' in personal %} \newcommand{\phone}{ {{ personal.phone }} } {% endif %}
{% if 'slogan' in personal %} \newcommand{\slogan}{ {{ personal.slogan }} } {% endif %}
...
\begin{cvtable}[]
	{% for entry in experience %}
		\cvitem { {{ entry.start_year }} -- {{ entry.end_year }} } {\textbf{ {{entry.title}} } }
			{ {{ entry.institution}} }
			{ 
				{\small
...
\begin{cvtable}
	{% for entry in publications %}
		\cvpubitem{ {{entry.title}} }{ {{entry.coauthors}} }{ {{entry.venue}} }{ {{ entry.year }} }	
	{% endfor %}
\end{cvtable}
{% endif %}
